...
export const metadata = { title: "Annunci — Rione di Lugano" };
  ...
  return (
    <>
      ...
      <div className="pt-16">
        ...
        >
          <h1 className="font-heading text-2xl sm:text-3xl text-white">Annunci</h1>
          <p className="text-blue-200 mt-1 text-sm">Comunicati e avvisi del rione</p>
        </div>
        <main className="mx-auto max-w-3xl px-4 py-8">
          <Suspense>
            <CategoryPageClient category="annunci" />
          </Suspense>
        </main>
